...
import { LayoutDashboard, Package, Tag, ShoppingBag, LogOut, Menu, X, ChevronLeft, Users, Settings, FolderOpen, Puzzle, BarChart3, Palette } from 'lucide-react';
...
const baseNavItems: NavItem[] = [
  ...
  { path: '/admin/addons', label: 'Complementos', icon: Puzzle },
  { path: '/admin/coupons', label: 'Cupons', icon: Tag },
  { path: '/admin/branding', label: 'Personalização', icon: Palette },
